import SwiftBackports
    ...
    internal struct ToolbarBackgroundModifier: ViewModifier {
        ...
        func body(content: Content) -> some View {
            content
                .introspect(.viewController, on: .iOS(.v13...)) { viewController in
                    wrapper.controller = viewController
                }
                .backport.task(id: wrapper.controller) {
                    updateNavigationBar()
                    updateBottomBar()
                    updateTabBar()
                }
        ...
        private func updateNavigationBar() {
            guard toolbarVisibility.navigationBar != nil || toolbarViews.navigationBar != nil else {
                return
            }
        ...
        private func updateBottomBar() {
            guard toolbarVisibility.bottomBar != nil || toolbarViews.bottomBar != nil else {
                return
            }
